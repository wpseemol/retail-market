...
export default function BottomBanners() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-6">
            ...
            <article className="relative overflow-hidden rounded-xl border border-border-default min-h-[170px] sm:min-h-[190px] p-6 sm:p-7 flex items-center justify-between group">
                ...
                <div className="relative z-10 flex flex-col items-start max-w-[260px]">
                ...
                <div className="relative z-10 w-[140px] h-[130px] sm:w-[170px] sm:h-[150px] shrink-0 flex items-center justify-center">
                    <Image
            ...
            <article className="relative overflow-hidden rounded-xl border border-border-default min-h-[170px] sm:min-h-[190px] p-6 sm:p-7 flex items-center justify-between group">
                ...
                {/* 25% Rosette Badge */}
                <div
                    className="absolute right-[145px] sm:right-[175px] top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-brand-primary text-white flex flex-col items-center justify-center text-center shadow-md z-20"
