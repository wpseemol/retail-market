...
import { Pencil, Search, Shield, UserRound, Users } from "lucide-react";
import {
    ApiError,
    apiFetch,
    type ManagedUser,
        ...
        <div className="flex flex-col gap-6">
            ...
            <FadeIn>
                <section className="overflow-hidden rounded-2xl border border-border/80 bg-card shadow-sm">
                    <div className="border-b border-border/70 bg-linear-to-r from-brand-tint/40 via-background to-background px-5 py-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-0.5 text-xs text-muted-foreground">
                                    Search and filter, then open a profile to
                                    edit
                                </p>
                            </div>
                        </div>
                            ...
                            <ul className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                                {users.map((user) => (
                                    <li key={user.id}>
                                        <Link
                                            to={`/users/${user.id}`}
                                            className="group flex h-full flex-col gap-3 rounded-2xl border border-border/80 bg-linear-to-br from-background to-muted/20 p-4 transition-all hover:border-brand-primary/30 hover:shadow-md"
                                        >
                                            <div className="flex items-start gap-3">
